# Type 1:
- Đến bây giờ, tất cả chúng ta đều đã quen với những câu chuyện về việc chính phủ hứa hẹn quá mức và thực hiện dưới mức.
  ```
...
# Type 2:
```
Tướng Perna mời chúng tôi đến để giúp ông ấy xem xét chuỗi cung ứng,
giữa chính phủ và các đối tác trong ngành. Bằng cách sử dụng Palantir Foundry,
chúng tôi đã hợp nhất hàng nghìn luồng dữ liệu vào một nền tảng mang lại
cho anh ấy nhận thức toàn diện về miền--một “cái nhìn của Chúa” thực sự--về tình hình thực tế.
